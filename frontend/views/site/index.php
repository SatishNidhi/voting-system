        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content scroll-div">
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="Sample Page" class="nav-item"><a href="#" class="nav-link"><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">My Profile</span></a></li>
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="<?=Url::base(true).'/public/images'?>/user/avatar-1.jpg" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="<?=Url::base(true).'/public/images'?>/user/avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="<?=Url::base(true).'/public/images'?>/user/avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    <tbody>
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="<?=Url::base(true).'/public/images'?>/user/avatar-1.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="<?=Url::base(true).'/public/images'?>/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="<?=Url::base(true).'/public/images'?>/user/avatar-3.jpg" alt="activity-user"></td>
                                                            <td>
